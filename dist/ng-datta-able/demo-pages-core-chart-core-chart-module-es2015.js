...
const routes = [
    {
        ...
        children: [
            {
                path: 'morris',
                loadChildren: () => __webpack_require__.e(/*! import() | crt-morris-crt-morris-module */ "crt-morris-crt-morris-module").then(__webpack_require__.bind(null, /*! ./crt-morris/crt-morris.module */ "./src/app/demo/pages/core-chart/crt-morris/crt-morris.module.ts")).then(m => m.CrtMorrisModule)
            }
        ]
    }
];
