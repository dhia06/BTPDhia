...
const routes = [
    {
        ...
        children: [
            {
                path: 'default',
                loadChildren: () => __webpack_require__.e(/*! import() | default-default-module */ "default-default-module").then(__webpack_require__.bind(null, /*! ./default/default.module */ "./src/app/demo/dashboard/default/default.module.ts")).then(m => m.DefaultModule)
            }
        ]
    }
];
...
/* harmony import */ var _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dashboard-routing.module */ "./src/app/demo/dashboard/dashboard-routing.module.ts");
