    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          "./src/app/demo/pages/authentication/auth-signup/auth-signup.module.ts")).then(function (m) {
            return m.AuthSignupModule;
          });
        }
      }, {
        path: 'signin',
        loadChildren: function loadChildren() {
          ...
          "./src/app/demo/pages/authentication/auth-signin/auth-signin.module.ts")).then(function (m) {
            return m.AuthSigninModule;
          });
        }
      }]
    }];
